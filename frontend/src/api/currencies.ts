...
/**
 * Serwis obsługujący pobieranie i transformację listy walut.
 */
/** 
 * Mapa wyjątków dla kodów krajów, których flaga nie odpowiada pierwszym 
 * dwóm literom kodu waluty (np. EUR -> EU zamiast EU).
 */
...
/**
 * Pobiera listę dostępnych walut z API i wzbogaca ją o adresy URL flag państw.
 * Wykorzystuje FlagCDN do generowania ikon na podstawie kodów ISO.
 * * @returns {Promise<CurrencyOption[]>} Tablica sformatowanych opcji walutowych.
 */
